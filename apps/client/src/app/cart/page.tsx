        ...
        <div className="w-full flex flex-col lg:flex-row gap-16">
          ...
          <div className="w-full lg:w-5/12 shadow-lg border-gray-100 p-8 rounded-lg flex flex-col gap-8 h-max">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex justify-between text-sm">
                <p className="text-gray-500">Shippng fee</p>
                <p className="font-medium">$10</p>
              </div>
            ...
            {activeStep === 1 && (
              <button onClick={()=> router.push("cart?step=2", { scroll: false })} className="w-full bg-gray-800 text-white p-2 border-lg cursor-pointer flex items-center justify-center gap-2 hover:bg-gray-900 transition-all duration-300 rounded-lg">
                Continue
